...
import type { Board, DragOverCard, DragOverList, DragPayload } from "../types";
...
type Props = {
  ...
  onDragStartList: (e: React.DragEvent<HTMLSpanElement>, boardId: number) => void;
  onDragEndAny: () => void;

  onDragOverListContainer: (e: React.DragEvent<HTMLDivElement>, targetBoardId: number) => void;
  onDropOnListContainer: (e: React.DragEvent<HTMLDivElement>, targetBoardId: number) => void;
  onDragLeaveListContainer: (e: React.DragEvent<HTMLDivElement>, targetBoardId: number) => void;
  ...
  // End zone
  onDragOverListEndZone: (e: React.DragEvent<HTMLDivElement>, targetBoardId: number) => void;
  onDropOnListEndZone: (e: React.DragEvent<HTMLDivElement>, targetBoardId: number) => void;
